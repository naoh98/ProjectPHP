...
<head>
    ...
    <!-- style for dialog box jqeury ui -->
    ...
    <link href="{{ asset('/sbadmin2/css/style.css',true) }}" rel="stylesheet">
...
<script src="{{ asset('/sbadmin2/js/jquery.js',true) }}"></script>
<script src="{{ asset('/sbadmin2/js/sb-admin-2.min.js',true) }}"></script>
<!-- jquery ui for dialog box -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>

<!-- Page level plugins -->
<script src="{{ asset('/sbadmin2/vendor/chart.js/Chart.min.js',true) }}"></script>

<!-- Page level custom scripts -->
<script src="{{ asset('/sbadmin2/js/demo/chart-area-demo.js',true) }}"></script>
<script src="{{ asset('/sbadmin2/js/demo/chart-pie-demo.js',true) }}"></script>
